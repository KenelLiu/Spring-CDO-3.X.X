...
public class ResetPage implements java.io.Serializable {
     ...
     * Field fetchPage.
     */
    private com.cdoframework.cdolib.database.xsd.types.ResetPageFetchPageType fetchPage = com.cdoframework.cdolib.database.xsd.types.ResetPageFetchPageType.fromValue("FIRST");
    ...
    public ResetPage() {
        ...
        setFetchPage(com.cdoframework.cdolib.database.xsd.types.ResetPageFetchPageType.fromValue("FIRST"));
     ...
     */
    public com.cdoframework.cdolib.database.xsd.types.ResetPageFetchPageType getFetchPage() {
     ...
     */
    public void setFetchPage(final com.cdoframework.cdolib.database.xsd.types.ResetPageFetchPageType fetchPage) {
     ...
     */
    public static com.cdoframework.cdolib.database.xsd.ResetPage unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.cdoframework.cdolib.database.xsd.ResetPage) org.exolab.castor.xml.Unmarshaller.unmarshal(com.cdoframework.cdolib.database.xsd.ResetPage.class, reader);
    }
