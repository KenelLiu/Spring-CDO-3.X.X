...
public class SQLBlockTypeItem implements java.io.Serializable {
     ...
     * Field SQLIf.
     */
    private com.cdoPlugin.cdolib.database.xsd.SQLIf SQLIf;

    /**
     * Field SQLFor.
     */
    private com.cdoPlugin.cdolib.database.xsd.SQLFor SQLFor;

    /**
     * Field SQLSwitch.
     */
    private com.cdoPlugin.cdolib.database.xsd.SQLSwitch SQLSwitch;
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.SQLFor getSQLFor() {
        return this.SQLFor;
    }
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.SQLIf getSQLIf() {
        return this.SQLIf;
    }
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.SQLSwitch getSQLSwitch() {
     ...
     */
    public void setSQLFor(final com.cdoPlugin.cdolib.database.xsd.SQLFor SQLFor) {
        this.SQLFor = SQLFor;
     ...
     */
    public void setSQLIf(final com.cdoPlugin.cdolib.database.xsd.SQLIf SQLIf) {
        this.SQLIf = SQLIf;
     ...
     */
    public void setSQLSwitch(final com.cdoPlugin.cdolib.database.xsd.SQLSwitch SQLSwitch) {
