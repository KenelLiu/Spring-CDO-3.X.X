...
public class DataServiceChoiceItem implements java.io.Serializable {
     ...
     * Field SQLTrans.
     */
    private com.cdoPlugin.cdolib.database.xsd.SQLTrans SQLTrans;
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.SQLTrans getSQLTrans() {
     ...
     */
    public void setSQLTrans(final com.cdoPlugin.cdolib.database.xsd.SQLTrans SQLTrans) {
