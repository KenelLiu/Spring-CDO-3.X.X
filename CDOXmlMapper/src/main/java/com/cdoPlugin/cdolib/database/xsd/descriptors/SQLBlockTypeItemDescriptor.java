...
public class SQLBlockTypeItemDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SQLBlockTypeItemDescriptor() {
        ...
        desc.setValidator(fieldValidator);
        //-- SQLIf
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoPlugin.cdolib.database.xsd.SQLIf.class, "SQLIf", "SQLIf", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLBlockTypeItem target = (SQLBlockTypeItem) object;
                    target.setSQLIf( (com.cdoPlugin.cdolib.database.xsd.SQLIf) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoPlugin.cdolib.database.xsd.SQLIf();
            }
        };
        ...
        desc.setValidator(fieldValidator);
        //-- SQLFor
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoPlugin.cdolib.database.xsd.SQLFor.class, "SQLFor", "SQLFor", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLBlockTypeItem target = (SQLBlockTypeItem) object;
                    target.setSQLFor( (com.cdoPlugin.cdolib.database.xsd.SQLFor) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoPlugin.cdolib.database.xsd.SQLFor();
            }
        };
        ...
        desc.setValidator(fieldValidator);
        //-- SQLSwitch
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(com.cdoPlugin.cdolib.database.xsd.SQLSwitch.class, "SQLSwitch", "SQLSwitch", org.exolab.castor.xml.NodeType.Element);
        handler = new org.exolab.castor.xml.XMLFieldHandler() {
            @Override
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
                ...
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SQLBlockTypeItem target = (SQLBlockTypeItem) object;
                    target.setSQLSwitch( (com.cdoPlugin.cdolib.database.xsd.SQLSwitch) value);
                } catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            }
            ...
            @SuppressWarnings("unused")
            public java.lang.Object newInstance(java.lang.Object parent) {
                return new com.cdoPlugin.cdolib.database.xsd.SQLSwitch();
            }
        };
    ...
    public java.lang.Class getJavaClass() {
        return com.cdoPlugin.cdolib.database.xsd.SQLBlockTypeItem.class;
    }
