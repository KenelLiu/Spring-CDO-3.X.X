...
public class Return implements java.io.Serializable {
    ...
    private java.util.List<com.cdoPlugin.cdolib.database.xsd.ReturnItem> returnItemList;

    public Return() {
        super();
        setText("OK");
        this.returnItemList = new java.util.ArrayList<com.cdoPlugin.cdolib.database.xsd.ReturnItem>();
    }
     ...
     */
    public void addReturnItem(final com.cdoPlugin.cdolib.database.xsd.ReturnItem vReturnItem) throws java.lang.IndexOutOfBoundsException {
     ...
     * given is outside the bounds of the collection
     */
    public void addReturnItem(final int index,final com.cdoPlugin.cdolib.database.xsd.ReturnItem vReturnItem) throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<? extends com.cdoPlugin.cdolib.database.xsd.ReturnItem> enumerateReturnItem() {
     ...
     * index
     */
    public com.cdoPlugin.cdolib.database.xsd.ReturnItem getReturnItem(final int index) throws java.lang.IndexOutOfBoundsException {
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.ReturnItem[] getReturnItem() {
        com.cdoPlugin.cdolib.database.xsd.ReturnItem[] array = new com.cdoPlugin.cdolib.database.xsd.ReturnItem[0];
     ...
     * collection
     */
    public java.util.Iterator<? extends com.cdoPlugin.cdolib.database.xsd.ReturnItem> iterateReturnItem() {
     ...
     */
    public boolean removeReturnItem(final com.cdoPlugin.cdolib.database.xsd.ReturnItem vReturnItem) {
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.ReturnItem removeReturnItemAt(final int index) {
        java.lang.Object obj = this.returnItemList.remove(index);
        return (com.cdoPlugin.cdolib.database.xsd.ReturnItem) obj;
    }
     ...
     * given is outside the bounds of the collection
     */
    public void setReturnItem(final int index,final com.cdoPlugin.cdolib.database.xsd.ReturnItem vReturnItem) throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        if (index < 0 || index >= this.returnItemList.size()) {
     ...
     */
    public void setReturnItem(final com.cdoPlugin.cdolib.database.xsd.ReturnItem[] vReturnItemArray) {
        //-- copy array
     ...
     */
    public static com.cdoPlugin.cdolib.database.xsd.Return unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.cdoPlugin.cdolib.database.xsd.Return) org.exolab.castor.xml.Unmarshaller.unmarshal(com.cdoPlugin.cdolib.database.xsd.Return.class, reader);
    }
