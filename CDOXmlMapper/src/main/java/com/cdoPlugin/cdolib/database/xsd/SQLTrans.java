...
public class SQLTrans implements java.io.Serializable {
     ...
     * Field propagation.
     */
    private com.cdoPlugin.cdolib.database.xsd.types.SQLTransPropagationType propagation = com.cdoPlugin.cdolib.database.xsd.types.SQLTransPropagationType.fromValue("REQUIRED");
     ...
     */
    private com.cdoPlugin.cdolib.database.xsd.SQLTransChoice SQLTransChoice;

    /**
     * Field onException.
     */
    private com.cdoPlugin.cdolib.database.xsd.OnException onException;
    ...
    public SQLTrans() {
        super();
        setPropagation(com.cdoPlugin.cdolib.database.xsd.types.SQLTransPropagationType.fromValue("REQUIRED"));
    }
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.OnException getOnException() {
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.types.SQLTransPropagationType getPropagation() {
     ...
     */
    public com.cdoPlugin.cdolib.database.xsd.SQLTransChoice getSQLTransChoice() {
     ...
     */
    public void setOnException(final com.cdoPlugin.cdolib.database.xsd.OnException onException) {
     ...
     */
    public void setPropagation(final com.cdoPlugin.cdolib.database.xsd.types.SQLTransPropagationType propagation) {
     ...
     */
    public void setSQLTransChoice(final com.cdoPlugin.cdolib.database.xsd.SQLTransChoice SQLTransChoice) {
     ...
     */
    public static com.cdoPlugin.cdolib.database.xsd.SQLTrans unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.cdoPlugin.cdolib.database.xsd.SQLTrans) org.exolab.castor.xml.Unmarshaller.unmarshal(com.cdoPlugin.cdolib.database.xsd.SQLTrans.class, reader);
    }
