...
public class ReturnItem implements java.io.Serializable {
     ...
     */
    public static com.cdoPlugin.cdolib.database.xsd.ReturnItem unmarshal(final java.io.Reader reader) throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (com.cdoPlugin.cdolib.database.xsd.ReturnItem) org.exolab.castor.xml.Unmarshaller.unmarshal(com.cdoPlugin.cdolib.database.xsd.ReturnItem.class, reader);
    }
